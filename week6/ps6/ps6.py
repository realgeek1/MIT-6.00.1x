...
def get_story_string():
    ...
    """
    f = open("C:\Users\Admin\Desktop\MIT 6.00.1x\week6\ps6\story.txt", "r")
    story = str(f.read())
    f.close()
    return story
...
WORDLIST_FILENAME = 'C:\Users\Admin\Desktop\MIT 6.00.1x\week6\ps6\words.txt'
...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in lower:
            shiftl[i] = lower[(lower.find(i)+shift)]
        for a in upper:
            shiftu[a] = upper[(upper.find(a)+shift)]
        fullshift = shiftu.copy()
        fullshift.update(shiftl)
        return fullshift
    ...
    def apply_shift(self, shift):
        ...
        '''
        list1 = []
        fullshift = self.build_shift_dict(shift)
        for char in self.message_text:
            if char in string.ascii_lowercase:
                list1.append(fullshift[char])
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for i in xrange(0,26):
            list2.append((super(CiphertextMessage,self).apply_shift(i),i))
        for (a,b) in list2:
            #for (a,b) in tup:
                counter = 0
                for word in a.split():
